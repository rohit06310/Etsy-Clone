...
from .models import Cart, Catagory, Favourite, Product
...
def order_details(request):
    ...
    total_products = sum(item.product_qty for item in cart_items)
...
def receipt_view(request):
    # Example logic
    payment_done = True  # or False, based on your logic
